...
\section{Definir CMake para la compilación y el enlazadoy obtener el esqueleto del código del proyecto}
Por último, dado que vamos a utilizar las herramientas de Visualstudio Code para compilar nuestro código, debemos añadir a nuestro proyecto las instrucciones para hacerlo empleando \texttt{CMAKE}, ya que esta en Visualstudio la opción por defecto.
