...
Esta operación hay que hacerla por partes, tal y como se muestra en el listado de código \ref{windup} (líneas 9-15). En primer lugar calculamos el producto de $A_d$ por $\hat{x}$ y guardamos el resultado en la variable temporal \texttt{temp1\_mat}. Hacemos los mismo con $B_d$ y la entrada real que vamos aplicar al motor y guardamos el resultado en \texttt{temp2\_mat} y con $L$ y el error de estimación y guardamos el resultado en \texttt{temp3_mat}. A continuación sumamos los tres resultados. la suma tambien debemos hacerla en dos pasos, ya que estamos empleando todo el tiempo las funciones de la libreria CMSIS-DSP.
