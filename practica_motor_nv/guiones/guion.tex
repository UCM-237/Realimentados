...
El STM32 cuenta con periféricos de hardware dedicados (temporizadores o \textit{Timers}) que pueden encargarse de tareas críticas en tiempo real sin consumir recursos del procesador. Para aprovechar esto, debemos conectar las señales del motor a los pines físicos del microcontrolador que soporten la \textit{Función Alternativa} requerida.
...
El corazón de nuestro sistema reside en la función \texttt{Motor\_update(void)}, la cual es invocada estrictamente cada 10 milisegundos por la rutina de atención a la interrupción (ISR) del \texttt{TIM4}. 
...
Es archivo puede manejarse desde cualquier hola de cálculo o importarlo en python para operar con los datos obtenidos.
