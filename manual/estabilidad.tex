...
\end{equation*}
 ...
 \begin{equation}
 \lim_{x1\to\infty,x2=0} \frac{x_1^2}{x_2^2+1}+x_2^2 = 1
 \end{equation}
...
\centering
\includegraphics[scale=0.35]{lyapunov_v.eps}
\caption{Función $V(x) = X_1^2+X_2^2$.}
\end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[scale=0.3]{lyapunov_nivel.eps}
...
\begin{corollary}[Teorema de Barbashim-Krasovskii]
