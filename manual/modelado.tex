...
Un aspecto interesante que ha salido de pasada, es el estudio de la estabilidad estructural; cuando un sistema mantiene el mismo comportamiento bajo pequeñas perturbaciones.

\begin{figure}
\subfigure[Función $\mu < 0$.]{\includegraphics[scale=0.35]{hopfsub.eps}}
