...
\begin{example}[Bifurcación de Hopf]
Consideremos el sistema,
\begin{align*}
...
\item Comprobar mediante simulación,  que para el $sigma < 1$, el sistema converge a su único  punto de equilibrio. Para $\sigma = 1$ el sistema sufre una bifurcación de horquilla, Obtener los puntos de equilibrio del sistema y comprobarlo.
 \end{enumerate}
\end{enumerate}
