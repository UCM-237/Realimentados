...
\begin{enumerate}
\item Simular el modelo de Volterra-Lotke para parámetros fijos, por ejemplo $a=b=c=d=1$. Emplear para ello tanta Matlab como simulink. Emplear distintas condiciones iniciales. Obtener tanto un gráfico de la evolución temporal de los estados como el diagrama de fases.
...
\item Comprobar que el resultado de integrar el sistema para un tiempo negativo es idéntico a obtener las soluciones del sistema presentado en ejemplo \ref{ex:hopf}, tomando $\mu=1$.
\end{itemize}
