...
\begin{equation}
\delta x(t) = P\exp(J_rt)P^{-1}x_0 
\end{equation}

donde  $J_r$ es la forma de Jordan real de la matriz A y $P,\ J_r=P^{-1}AP$ es una matriz formada por los autovalores de $A$. La matriz de Jordan, en este caso bidimensional, puede tomar una de las siguientes formas,
\begin{equation}
\begin{bmatrix}
...
\begin{figure}
\includegraphics[scale=0.8]{resp_inv.eps}
