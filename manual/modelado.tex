...
\begin{figure}
\subfigure[Silla-nodo]{\includegraphics[scale=0.35]{sadlenode2.eps}}
\label{fig:saddlenode}
\subfigure[Transcrítica]{\includegraphics[scale=0.35]{trans2.eps}}
\label{fig:trans}
...
\begin{figure}
\subfigure[Horquilla]{\includegraphics[scale=0.35]{pitchfork2.eps}}
\label{fig:horquilla}
\subfigure[No existe bifurcación]{\includegraphics[scale=0.35]{nobif2.eps}}
\label{fig:nobif}
